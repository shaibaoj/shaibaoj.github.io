var vmToolPic = new Vue({
	...
	data: {
		...
		objSpike: {
			...
			"/https://www.haodanku.comPublic/assets/home/images/tool/Tsps2.png", 
	...
	mounted: function() {
		...
		document.images && (img1 = new Image, img2 = new Image, img3 = new Image, img4 = new Image, img5 = new Image, img1.src = this.objSpike.swpierImg[0], img2.src = this.objSpike.swpierImg[1], img3.src = this.objSpike.swpierImg[2], img4.src = "/Public/assets/home/images/tool/Tsp1.png", img5.src = "/Public/assets/home/images/tool/Tsp2.png")
	},
	created: function() {
		this.isFileReader()
	},
