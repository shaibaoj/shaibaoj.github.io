...
define(["template"
		...
		,"text!common/module/"+cms_all_config.template+"/tpl/top.tpl"
		,"../util/css"
		,"common/module/"+cms_all_config.template+"/require/top"
		...
		show_goods:function(){
			...
			$.ajax({
				...
				success: function (result) {
					var render_data = $.extend({}, cms_all_data,result.result.map,{'goods_action':'top'});
