...
?>
    <div class="tk-list-choice page-all mb20">
        <div class="list-choice-first clearfix">
            <a href="<?php echo $cate_url; ?>?cid="><span <?php if(empty($arr_query['cid'])){ ?>class="red"<?php } ?>>全部优惠<em>(<?php echo $product_count; ?>)</em></span></a>
            <?php
    ...
    <div class="list-info page-all mb30">
        <div class="list-info-cont" id="listArea">
            <ul class="list-warp clearfix">
                <?php include(constant("TAOKE_TEMPLATE_PATH")."/cms/".$taoke_cms['path'].'/util/product.php');?>
            </ul>
