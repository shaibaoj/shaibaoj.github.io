        ...
        <div class="detail-right">
            ...
            <div class="price-block">
                ...
                <p class="line-block">
                    ...
                    <span class="text"><?php echo $product['money']; ?>元优惠券</span>
                    <span  class="text">单笔满<?php echo $product['condition']; ?>元可用，每人限领1 张</span>
                </p>
                <?php } ?>
            </div>
            ...
            <a target="_blank" class="take-quan-btn mb30 mall-click" href="<?php echo CPS::query_common_url($product['url'],$product['mall']['id'],$user_cms['user_id'],$user_cms['app_id'],$agent_id,0); ?>" data-url="<?php echo $product['url']; ?>"  data-mallid="<?php echo $product['mall']['id']; ?>" data-uid="<?php echo $user_cms['user_id']; ?>" data-pid="<?php echo $user_cms['app_id']; ?>" data-aid="<?php echo $agent_id; ?>">下单后拿返利</a>
            <?php if(!empty($goods_coupon_price)){ ?>
            <a href="$product['coupon_url']" class="take-quan-btn mb30" target="_blank" rel="nofollow">先领券</a>
            <?php } ?>
