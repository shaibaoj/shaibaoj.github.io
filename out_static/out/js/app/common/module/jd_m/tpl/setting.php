        ...
        <div class="userBox">
            <ul class="address-show">
                <li class="normal">
                    ...
                    <input type="text" autocomplete="off" placeholder="" x-webkit-speech="" id="member-qq" class="normal-input fl">
                </li>
                <li class="normal">
                    <span class="fl">手机号：</span>
                    <input type="text" value="" id="member-mobile" autocomplete="off" class="normal-input fl" >
                </li>
                <li class="normal">
                    <span class="fl">email：</span>
                    <input type="text" value="" id="member-email" autocomplete="off" class="normal-input fl">
                </li>
                <li class="normal">
                    <span class="fl">支付宝：</span>
                    <input type="text" value="" id="member-alipay" autocomplete="off" class="normal-input fl">
                </li>
                <li class="normal">
                    <span class="fl">登录密码：</span>
                    <input type="text" placeholder="请输入当前的登录密码"  value="" id="member-passwd" autocomplete="off" class="normal-input fl">
                </li>
            </ul>
            <div class="activate-show">
                <p class="wap-tips" id="err" style="display: none;"></p>
                <a class="activate-btn active setting-btn" href="javascript:void(0);" id="act_btn ">提交修改</a>
            </div>
