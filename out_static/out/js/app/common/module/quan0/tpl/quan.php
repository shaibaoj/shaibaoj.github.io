...
<a rel="nofollow" class="coupon-btn" href="https://shop.m.taobao.com/shop/coupon.htm?seller_id=<?php echo $user_num_id; ?>&activityId=<?php echo $activity_id; ?>" target="_blank" title="领券后请点击右边按钮下单">点击领取</a>
</div>
