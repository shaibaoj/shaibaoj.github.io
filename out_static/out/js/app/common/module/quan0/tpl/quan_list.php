...
<link rel="stylesheet" type="text/css" href="<?php echo $url_prefix_item['search_static_css']; ?>/taoke/template/cms/<?php echo $taoke_cms['path']; ?>/css/Coupon.css?v=09181" />
</head>
<body>
...
<?
    ...
    if(strstr($cate_url,"?")){$cate_url = $cate_url.'&';}else{$cate_url = $cate_url.'?';}
?>
<div class="search-wrap main-container"></div>
<div class="cat-wrap main-container">
<div class="cat-list clearfix">
<ul class="clearfix">
<li class="<?php if(empty($arr_query['cid'])){ ?>class="active"<?php } ?>"><a class="cnzzCounter" data-cnzz-type="51" data-cnzz="100" href="<?php echo $cate_url; ?>?cid=">全部优惠（<?php echo $goods_count; ?>）</a></li>
<?php
       foreach ($taoke_cms_category_list as $key => $category_item) {
    ?>     
<li <?php if($category_item['c_id']==$arr_query['cid']){ ?>class="active"<?php } ?>  ><a class="cnzzCounter" data-cnzz-type="52" data-cnzz="2"  href="<?php echo $cate_url; ?>cid=<?php echo $category_item['c_id']; ?>"><?php echo $category_item['short_name']; ?></a><span></span></li>
 <?php } ?>  
</ul>
</div>
<div class="sort-wrap">
...
<a class="<?php if(empty($sort)||$sort=='default'){?>active<?php } ?>" href="<?php echo $sort_url; ?>sort=default">默认</a>
<a class="<?php if($sort=='coupon'){?>active<?php } ?>" href="<?php echo $sort_url; ?>sort=coupon&order_next=ASC" style="margin-left:5px;">即将抢完</a>
<a class="<?php if($sort=='volume'){?>active<?php } ?>" href="<?php echo $sort_url; ?>sort=volume&order_next=DESC" style="margin-left:5px;">销量</a>
<a class="<?php if($sort=='coupon_price'){?>active<?php } ?>" href="<?php echo $sort_url; ?>sort=coupon_price&order_next=DESC" style="margin-left:5px;">优惠最多</a>
</div>
</div>
...
<div class="tags">
<span class="text" style="margin-left: 50px; color:#969696">热门标签：</span>
