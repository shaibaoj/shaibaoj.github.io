...
<title><?php echo $user_cms['title']; ?></title><!--网站标题-->
...
<div class="nav-slider page-all mb20 clearfix">
    ...
    ?>     
 <li><a href="<?php echo $model_base_url; ?>?action=quan_list&cid=<?php echo $category_item['c_id']; ?>"><i class="icon iconfont"><?php echo $category_item['icon']; ?></i><span><?php echo $category_item['title']; ?></span></a></li>
 <?php } ?>  
            </ul>
        </div>
    </div>
...
<div class="list-info page-all mb30">
    ...
    <div class="list-info-cont" id="listArea">
        ...
        <div class="see-more">
            <a href="<?php echo $model_base_url; ?>?action=quan_list" target="_blank">查看更多领券秒杀优惠 &gt;&gt;</a>
        </div>
    </div>
</div>
