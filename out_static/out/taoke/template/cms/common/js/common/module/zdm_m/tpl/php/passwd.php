        ...
        <div class="userBox">
            <ul class="address-show">
                <li class="normal">
                    ...
                    <input type="text" placeholder="输入原密码"  value="" id="member-passwd" autocomplete="off" class="normal-input fl">
                </li>
                <li class="normal">
                    <span class="fl">新密码：</span>
                    <input type="text" placeholder="输入新密码"  value="" id="member-passwd-new" autocomplete="off" class="normal-input fl">
                </li>
            </ul>
            <div class="activate-show">
                <p class="wap-tips" id="err" style="display: none;"></p>
                <a class="activate-btn active passwd-btn" href="javascript:void(0);" id="act_btn ">修改密码</a>
            </div>
