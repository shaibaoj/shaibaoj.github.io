    ...
    <div class="app">
        <div class="userBox">
            ...
            <div class="userItem">
                ...
                <a href="#">
                    <em class="iconfont icon-daifahuo"></em><span>可用现金:<em id="member_money_available"></em>元</span>                    
                </a>
            </div>
            <div class="activate-show coupon-active">
                <div class="activate-box">
                    <input type="text" autocomplete="off" placeholder="输入提现金额" x-webkit-speech="" name="activate_code" id="money-code" class="activate-key normalInput">
                </div>
                <p class="wap-tips err" style="display: none;"></p>
                <a class="activate-btn active payment-btn" href="javascript:void(0);" id="act_btn">输入提现金额</a>
            </div>
