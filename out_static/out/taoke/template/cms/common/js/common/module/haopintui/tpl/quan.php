...
<a rel="nofollow" class="coupon-btn" href="https://uland.taobao.com/quan/detail?sellerId=<?php echo $user_num_id; ?>&activityId=<?php echo $activity_id; ?>" target="_blank" title="领券后请点击右边按钮下单">领取</a>
</div>
