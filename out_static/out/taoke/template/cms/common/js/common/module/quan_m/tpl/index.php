...
<div class="index-wrapper">
    ...
    <div class="icon-link-wrapper">
        <ul class="icon-url-list clearfix">
            ...
            <?php } ?>
            <li class="icon-99by">
                <a href="<?php echo $model_base_url; ?>?action=quan_list&jiu=1" >
                    <i></i>
                    <span>9.9包邮</span>
                </a>
            </li>
            ...
            <li class="icon-xblj">
                <a href="<?php echo $model_base_url; ?>?action=quan_list&tuijian=1" >
                    <i></i>
                    <span>小编力荐</span>
                </a>
            </li>
            <li class="icon-jpsf">
                <a href="<?php echo $model_base_url; ?>?action=quan_list&cid=4" >
                    <i></i>
                    <span>居家日用</span>
                </a>
            </li>
