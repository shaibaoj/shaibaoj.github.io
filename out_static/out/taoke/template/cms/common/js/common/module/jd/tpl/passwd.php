...
<div class="list-info page-all mb30">
	<div class="my-juanpi">
        ...
        <div class="sider-bar">
            ...
            <li class=""><a href="<?php echo $model_base_url; ?>?action=member&to_page=setting">个人设置</a></li>
            <li class="active"><a href="<?php echo $model_base_url; ?>?action=member&to_page=passwd">密码设置</a></li>
		    </ul>
		</div>
        <!-- 二级导航 -->
