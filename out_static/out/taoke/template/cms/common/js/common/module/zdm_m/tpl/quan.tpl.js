...
{{if !item.goods_quan_type}} 
{{if item.coupon_money}}
<a href="https://uland.taobao.com/quan/detail?sellerId={{item.user_num_id}}&activityId={{item.activity_id}}" class="take-quan-btn mb30" target="_blank" rel="nofollow">先领券</a>
{{/if}}
