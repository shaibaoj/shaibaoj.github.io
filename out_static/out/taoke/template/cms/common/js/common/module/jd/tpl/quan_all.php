        ...
        <div class="detail-right">
            ...
            <div class="price-block">
                <p class="line-block">
                    ...
                    <del>￥<?php echo coreAppCache::number_format($goods_price); ?></del>
                </p>
                <p class="line-block">
            ...
            <div class="quan-block mb20">
                <i class="icon icon-tanhao"></i>已领券<span class="red"><?php echo $coupon_goods['applied_count']; ?></span>张<em>|</em>已有<span class="red"><?php echo $coupon_goods['volume']; ?></span>人购买，手慢无
            </div>
            ...
            <a href="<?php echo $taoke_item_m_url; ?>" class="take-quan-btn mb30" target="_blank" rel="nofollow">去领券下单</a>
<div class="">
...
<a href="https://uland.taobao.com/quan/detail?sellerId=<?php echo $user_num_id; ?>&activityId=<?php echo $activity_id; ?>" class="take-quan-btn mb30" target="_blank" rel="nofollow">先领券</a>
<?php } ?>
